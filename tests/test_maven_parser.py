...
def test_missed_end_of_tests2(qtbot, request):
    stdout = readStdout(testInputFolder / 'missed_end_of_tests_2.txt')
...
def test_tests_in_error(qtbot, request):
    stdout = readStdout(testInputFolder / 'tests_in_error.txt')
