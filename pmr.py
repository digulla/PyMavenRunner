...
class MavenRunnerFrame(QFrame):
    ...
    def __init__(self, parent = None):
        ...
        self.projects = [
            Project(devFolder / 'sqg-java-toolbox2.git'),
            Project(devFolder / 'swissquant-etl'),
            Project(devFolder / 'zurich-gkb-fork'),
            Project(devFolder / '185.6-anlageberatungstool'),
        ]
...
class MavenOutputProcessor(QThread):
    def __init__(self, runner, process, project, args):
        super().__init__()
    ...
    def run(self):
        try:
            self.runner.mavenStarted.emit(self.project, self.args)
...
class MavenRunner(QObject):
    ...
    def start(self):
        ...
        try:
            ...
            self.processor = MavenOutputProcessor(self, process, self.project, args)
